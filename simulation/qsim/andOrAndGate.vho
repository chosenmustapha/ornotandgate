...
-- in1	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- in2	=>  Location: PIN_28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- in3	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF andOrAndGate IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \X~0_combout\ = ((\in1~input_o\ & \in2~input_o\)) # (!\in3~input_o\)
